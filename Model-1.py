...
# This module used to auto-generate many plots at import time.
# To avoid creating many files unexpectedly, the file has been
# converted into a library of plotting functions. Scripts should
# import these functions or use the separate script
# `plot_3d_features.py` (added to the repo) to produce the single
# 3D diagram requested.
...
if __name__ == '__main__':
    print("Module 'Model-1.py' no longer auto-generates plots.\nTo create the single requested 3D diagram, run `plot_3d_features.py`.\n")